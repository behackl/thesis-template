...
\involvedpeople{
  \person{0.45\linewidth}{Betreuer}{Dipl.-Ing. Dr. Benjamin Hackl}{
    Institut für Mathematik und Wissenschaftliches Rechnen\\
    Universität Graz
  }\hfill
  \person[\flushright]{0.45\linewidth}{Gutachter}{Univ.-Prof. Dr.\ Alexandra Musterfrau}{
...
% === Usually, no changes are needed below this line to get started. ===
...
The following example provides verification for this important result. For
background on generating functions and related analytic methods, see the classic
reference by Flajolet and Sedgewick~\cite{flajolet_sedgewick_2009}.
...
The template includes basic support for source-code listings. Inline code such
as \code{gcd(2024, 71)} can be typeset with \verb|\code|, and longer SageMath or
Python snippets can be included using the \texttt{lstlisting} environment.

\begin{lstlisting}[caption={Euclid's algorithm in Sage/Python.}, label={lst:gcd}]
...
Listing~\ref{lst:gcd} computes the greatest common divisor by repeated division
with remainder.
